package tg.experta.kaba.activities.FoodDetails;
...
import tg.experta.kaba.data.Food.source.FoodTagDataSource;
...
public class FoodDetailsActivity extends AppCompatActivity implements OnImageClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // get food_tags
        List<Food_Tag> tags = FoodTagDataSource.findByFoodId(daoSession.getFood_TagDao(), foodEntity.id);
...
//        initFoodTags();
    ...
    private void initNameFood_N_RestaurantNames() {
        ...
        resto =  RestaurantLocalDataSource
   ...
   /* private void initFoodTags() {
    ...
    private void initSlidingBanner() {
        holder.slidingBanner.load(foodEntity.food_details_pictures);
    }
