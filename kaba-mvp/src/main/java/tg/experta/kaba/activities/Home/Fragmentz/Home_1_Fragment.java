...
import tg.experta.kaba.activities.Home.presenters.F_HomePresenter;
...
public class Home_1_Fragment extends BaseFragment implements F_HomeContract.View {
...
//        presenter = new F_HomePresenter()
    ...
    @Override
    public void showMainSliding(List<Ad> ads) {

    }

    @Override
    public void inflateMainRestaurants(List<RestaurantEntity> restaurantEntityList) {

    }

    @Override
    public void showPubLongList() {

    }

    @Override
    public void showLoadingProgress(boolean isVisible) {
