package tg.tmye.kaba.partner.activities.home;
...
import tg.tmye.kaba.partner.activities.calendar.CalendarActivity;
import tg.tmye.kaba.partner.activities.commands.CommandDetailsActivity;
import tg.tmye.kaba.partner.activities.commands.MyCommandsActivity;
...
import tg.tmye.kaba.partner.activities.hsn.CreateHSNActivity;
...
import tg.tmye.kaba.partner.activities.infos.ProfileActivity;
...
import static tg.tmye.kaba.partner.activities.menu.RestaurantMenuActivity.RESTAURANT_ID;
...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener, MyCommandContract.HomePageView, View.OnTouchListener, CompoundButton.OnCheckedChangeListener {
    ...
    CardView cardview_acccount_settings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardview_acccount_settings.setOnClickListener(this);
        ...
        ILog.print("notifications extra - dead notifz");
    ...
    private void initViews() {
        ...
        cardview_acccount_settings = findViewById(R.id.cardview_acccount_settings);
    }
...
//                showStats();
            ...
            case R.id.cardview_calendar:
             showCalendarActivity();
                break;
            case R.id.cardview_acccount_settings:
            editRestaurantProfileInformations();
                break;
        }
    }
