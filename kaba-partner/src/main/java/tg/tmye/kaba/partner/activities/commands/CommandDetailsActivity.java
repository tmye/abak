...
import tg.tmye.kaba.partner._commons.adapter.ShippingManRecyclerAdapter;
...
import tg.tmye.kaba.partner.activities.commands.presenter.CommandDetailsPresenter;
import tg.tmye.kaba.partner.cviews.OffRecyclerview;
import tg.tmye.kaba.partner.cviews.command_details_view.CommandProgressView;
import tg.tmye.kaba.partner.cviews.dialog.AcceptOrderConfirmationDialogFragment;
import tg.tmye.kaba.partner.cviews.dialog.CancelConfirmationDialogFragment;
...
public class CommandDetailsActivity extends LoadingIsOkActivtity implements CommandDetailsContract.View, View.OnClickListener {
    ...
    private AcceptOrderConfirmationDialogFragment accept_order_dialog;
...
//                        ib_action_button.setVisibility(View.GONE); // PATCH
                        ...
                        tv_select_shipping_man.setText(getResources().getString(R.string.please_accept_reject_order));
...
//                inflateShippingMenList(shippingMEN);
    ...
    private void acceptCommand() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (accept_order_dialog == null) {
                    accept_order_dialog = AcceptOrderConfirmationDialogFragment.newInstance();
                    showFragment(accept_order_dialog, "accept_order_dialog", true);
                } else {
                    showFragment(accept_order_dialog, "accept_order_dialog", true);
                }
            }
