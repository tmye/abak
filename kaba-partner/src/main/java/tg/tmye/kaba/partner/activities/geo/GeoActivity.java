package tg.tmye.kaba.partner.activities.geo;
...
public class GeoActivity extends FragmentActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.d(Constant.APP_TAG, "Maps - connection failed");
    }
