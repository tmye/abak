...
import tg.tmye.kaba.partner.activities.menu.contract.EditSingleFoodContract;
import tg.tmye.kaba.partner.activities.menu.presenter.EditSingleFoodPresenter;
...
//                .setSelectedFiles(null)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        /* on activity result */
        Log.d(Constant.APP_TAG, "on_activity result");
        switch (requestCode) {
