package tg.tmye.kaba._commons.cviews.custom_swipe;
...
public class HomeCustom_SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private void createProgressView() {
        mCircleView = new tg.tmye.kaba._commons.cviews.custom_swipe.CircleImageView(getContext(), CIRCLE_BG_LIGHT);
...
//        if (mTarget == null) {
//            mTarget = findViewById(mScrollableChildId);
//        }
    }
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(@NonNull HomeCustom_SwipeRefreshLayout parent, @Nullable View child);
    }
    ...
    protected void onFinishInflate() {
        ...
        setNestedScrollingEnabled(false);
                setProgressViewOffset(false, 120, 200);
    }
}
