...
public class GroupAdGridViewAdapter extends RecyclerView.Adapter<GroupAdGridViewAdapter.ViewHolder> {
    ...
    public GroupAdGridViewAdapter(Context ctx, List<AdsBanner> data, F_Home_1_Fragment.OnFragmentInteractionListener listener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(ctx).inflate(R.layout.group_ad_4_item_layout, parent, false));
    }

    @Override
    public void onBindViewHolder(GroupAdGridViewAdapter.ViewHolder holder, int position) {
...
//        holder.iv_add_pic.setImageResource(item.cloo);
       /* holder.iv_add_pic.setOnClickListener(new View.OnClickListener() {
        ...
        holder.itemView.setOnClickListener(new GroupAdGridViewAdapter.OnAdsClickListener(item));
