...
public class RestaurantAvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public RestaurantAvatarImageBehavior(Context context, AttributeSet attrs) {
        mContext = context;
