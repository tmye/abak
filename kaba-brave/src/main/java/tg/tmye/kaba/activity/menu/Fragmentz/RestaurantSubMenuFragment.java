package tg.tmye.kaba.activity.menu.Fragmentz;
...
//                    mListener.onFragmentInteraction(null);
            ...
            holder.ib_add_to_basket.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ((OnMenuAddedToBasket)getActivity())
                            .addMenu(holder.iv_pic, item);
                }
            });
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ImageButton ib_add_to_basket;
            ...
            public ViewHolder(View itemView) {
                ...
                ib_add_to_basket = itemView.findViewById(R.id.ib_add_to_basket);
            }
        }
